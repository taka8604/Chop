...
# OHLCV verisini almak için fonksiyon
...
# RMA (Exponential Moving Average) fonksiyonu
def rma(series, length):
    return series.ewm(alpha=1/length, adjust=False).mean()

# True Range (TR) fonksiyonu
def tr(data):
...
# Directional Movement Index hesaplama fonksiyonu
...
# Market pairs ve zaman dilimleri üzerinde analiz yapma fonksiyonu
...
# Binance bağlantısı başlatılıyor
...
# Tüm çiftler üzerinde analiz yapma
analyzed_pairs = []
...
# CHOP değeri 60'tan büyük olan çiftleri filtrele
...
# İşleri zamanlamak (UTC saat diliminde)
